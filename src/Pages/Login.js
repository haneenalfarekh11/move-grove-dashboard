...
import yourImage from '../Assets/istockphoto-2157089736-2048x2048.jpg';
const Login = () => {
  return (
    <div className='w-screen h-screen flex justify-between items-center bg-cover bg-center' style={{ backgroundImage: `url(${yourImage})` }}>
        <div className='w-[100%] h-[100%]  flex justify-center items-center flex-col '>
            <div className='w-[70%] h-[90%] rounded-xl bg-[#ecf0f1d3]  flex justify-center items-center flex-col'>
                ...
                <div className='w-[80%] h-[12%] relative'>
                    ...
                    <input type='email' id='email'defaultValue="Haneen" placeholder='cant be embty' className='w-[100%] h-[50%] p-2 rounded-md bg-[rgb(230,228,225)] outline-none text-white onChange={(e) => setValue(e.target.value)} '/>
                </div>
                <div className='w-[80%] h-[20%] relative'>
                    <label htmlFor='password' className='absolute -top-6 left-[1%] text-black'>Password</label>
                    <input type='password' id='password' defaultValue="1111" placeholder='cant be empty' className='w-[100%] h-[30%] p-2 rounded-md bg-[#e8e6e3] outline-none text-white onChange={(e) => setValue(e.target.value)} '/>
                </div>
